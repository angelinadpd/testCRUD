...
(this,function a(b,c){
	...
	function i(a,b){
		var c=a.length,d={};if(1>c||c>2)throw new Error("Invalid argument length");
	...
	function m(a,b){
		...
		var n={
			...
			p.prompt=function(){
				...
				i=a.show===c?!0:a.show,a.message=f,
				...
				a.show=!1,!a.title)throw new Error("prompt requires a title");
					...
					switch(h=b(n.inputs[a.inputType]),a.inputType){
						...
						case"time":
						case"number":
						case"password":h.val(a.value);
						break;
						case"select":var o={};if(k=a.inputOptions||[],!b.isArray(k))throw new Error("Please pass an array of input options");
				...
				var q={bg_BG:{OK:"Ок",CANCEL:"Отказ",CONFIRM:"Потвърждавам"
			},
			br:{
				OK:"OK",
				CANCEL:"Cancelar",
